...
CREATE TABLE general_account (
 id BIGINT NOT NULL PRIMARY KEY, account_class_id BIGINT NOT NULL, code NVARCHAR(64) NOT NULL, name NVARCHAR(255) NOT NULL,
...
CREATE TABLE subsidiary_account (
 id BIGINT NOT NULL PRIMARY KEY, general_account_id BIGINT NOT NULL, code NVARCHAR(64) NOT NULL, name NVARCHAR(255) NOT NULL,
