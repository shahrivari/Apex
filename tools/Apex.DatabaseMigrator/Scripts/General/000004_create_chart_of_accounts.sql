...
CREATE TABLE subsidiary_account (
 ...
 CONSTRAINT ck_subsidiary_nature CHECK(nature IN('DEBTOR','CREDITOR','NEUTRAL')), CONSTRAINT ck_subsidiary_detail_type CHECK(detail_account_type IN('BANK','SYMBOL','PERSON')),
