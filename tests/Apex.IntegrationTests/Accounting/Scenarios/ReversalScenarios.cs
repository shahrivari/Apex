...
public sealed class ReversalScenarios(ApexWebApplicationFactory factory) : AccountingScenarioTestBase(factory)
{
    ...
    private async Task<AccountingScenario> ArrangeFourAccountBookAsync()
    {
        ...
        await scenario.CreateSubsidiaryAccountAsync("EXPENSE", "01", "01", "Office Expense", AccountNature.Debtor, DetailAccountType.Person);
        ...
        await scenario.CreateSubsidiaryAccountAsync("REVENUE", "01", "01", "Fee Revenue", AccountNature.Creditor, DetailAccountType.Person);
        return scenario;
    }
