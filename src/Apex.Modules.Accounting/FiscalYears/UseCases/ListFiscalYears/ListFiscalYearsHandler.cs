...
public sealed class ListFiscalYearsHandler(
    IFiscalYearDirectoryRepository directoryRepository, IValidator<ListFiscalYearsRequest> validator)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var (rows, totalCount) = await directoryRepository.ListAsync(request.AccountingBookId, status,
